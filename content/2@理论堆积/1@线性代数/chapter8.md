...
x_4, free\\ 
x_5=2
\end{matrix}\right.$`可以写出parametric Rep_imgentation。如果我们在linear equation 有Free variables时，就代表有无穷多解(不同的`$x_2, x_4$`就有不同的`$x_1, x_3$`)。将上述的式子描述为parametric Rep_imgentation为`$\begin{bmatrix}
x_1\\ 
x_2\\ 
x_3\\ 
x_4\\ 
