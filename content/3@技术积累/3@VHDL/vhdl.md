...
这部分的笔记，是基于DiscreteTom作者所增添的。另外，参考了以下的一些资料进行学习。

- [DiscreteTom的VHDL学习文档](https://discretetom.github.io/academic/VHDL/vhdl/)
- [VHDL入门·解惑·经典实例·经验总结](http://download.eeworld.com.cn/detail/zhangkaixiu/560689)

下表是一些学习时的记录情况：

|时间|内容|补充|
|---|---|---|
|2021年6月14日|笔记初次学习并修改|修复md警告、增补了一些东西|

## 基本知识

- 代码**不区分大小写**
- 两个减号及后面的字符为单行注释
- 电路功能分为**顺序语句**和**并行语句**两种
...
-- 定义两个signal信号，port map进行组件调用和实体信号的映射
...
- 整体赋值，使用双引号：`temp := "10101001"`
- 逐位赋值，使用单引号：`temp(7) := '1`
- 多位赋值，使用双引号：`temp(7 downto 4) := "1010"`
